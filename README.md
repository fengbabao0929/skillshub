...
这是一个精心打造的 Claude Code Skills 集合，包含 **28 个实用 Skills**，涵盖内容创作、产品设计、教育培训、个人成长等多个领域。每个 Skill 都经过实战验证，帮助你在日常工作中更加高效。

**查看完整索引**: [SKILLS_INDEX.md](./SKILLS_INDEX.md)
...
#### 📖 [人生故事工作台](./life-story) (Life Story)
**描述**: 通过深度访谈，挖掘和整理个人故事，打造真实的个人IP
...
**核心功能**:
- 📝 6阶段深度访谈（童年→青春→转折→挣扎→意义→真实）
- ✍️ 多种写作风格（英雄之旅、私密对话、哲思等）
- 💾 访谈记录导出

---

#### 🎯 [IP自我介绍生成器](./ip-intro-generator) (IP Intro Generator)
**描述**: 生成高转化率的IP自我介绍
...
#### 📊 [副业适合度测评](./side-hustle-assessment) (Side Hustle Assessment)
**描述**: 评估副业适合度，5大维度深度分析
...
#### 🧑‍🏫 [青少年学习教练](./youth-learning-coach) (Youth Learning Coach)
**描述**: 青少年学习力文章写作助手
...
#### 💰 [财税审计内容生成器](./finance-content-generator) (Finance Content Generator)
**描述**: 财税审计类公众号内容生成
...
#### 🎭 [剧本杀编写器](./murder-mystery-generator) (Murder Mystery Generator)
**描述**: 生成培训体验类剧本杀
...
#### 📚 [培训大纲生成器](./training-outline-generator) (Training Outline Generator)
**描述**: 生成专业技能培训课程大纲
...
#### 🎴 [技能卡生成器](./skill-card-generator) (Skill Card Generator)
**描述**: 生成剧本杀技能卡
...
#### 📄 [文章分析器](./article-analyzer) (Article Analyzer)
**描述**: 分析对标文章结构风格
...
#### 💼 [成交型叙事生成器](./conversion-story-generator) (Conversion Story Generator)
**描述**: 根据目的/读者/行业定制的成交型叙事
...
#### 👔 [编辑部工作流](./editorial-workflow) (Editorial Workflow)
**描述**: 编辑部完整评审工作流
...
#### 🔍 [代码审查助手](./code-reviewer) (Code Reviewer)
**描述**: 专业代码审查，检查正确性、安全性、性能
...
#### ✍️ [内容写作助手](./content-writer) (Content Writer)
**描述**: 自媒体文案生成专家
...
#### ✨ [文本润色专家](./polish-expert) (Polish Expert)
**描述**: 专业文案润色
...
#### 🖼️ [文章配图生成器](./article-image-generator) (Article Image Generator)
**描述**: 为文章生成配图提示词
...
│   ├── content-writer/          # 内容写作助手
│   ├── polish-expert/           # 文本润色专家
│   ├── article-analyzer/        # 文章分析器
│   ├── conversion-story-generator/ # 成交型叙事生成器
│   ├── editorial-workflow/      # 编辑部工作流
...
│   ├── training-outline-generator/ # 培训大纲生成器
│   ├── youth-learning-coach/    # 青少年学习教练
│   ├── youth-learning-article-writer/ # 青少年学习文章
│   └── murder-mystery-generator/ # 剧本杀编写器
│
├── 📁 个人成长类 (4个)
│   ├── life-story/              # 人生故事工作台
│   ├── ip-intro-generator/      # IP自我介绍生成器
│   ├── side-hustle-assessment/  # 副业适合度测评
